...
UPGRADES_SCANCODES = {pygame.KSCAN_G}
    ...
    def poll(self) -> tuple[InputState, bool]:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                elif event.key == pygame.K_g or scancode in UPGRADES_SCANCODES:
                    upgrades_pressed = True
        ...
        state = InputState(
            ...
            upgrades_pressed=upgrades_pressed,
